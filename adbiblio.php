...
<div id="cont_col3">
    <div class="col1">
      ...
      <ul>
       ...
       <div class="col2">
      <h1>Enregistrer les ouvrages</h1> 
      <div class="erreur"><?php echo $erreur ?></div> 
      <form name="fo" method="post" action=""> 
         <input type="text" name="id" placeholder="id" value="<?php echo $id?>" /><br /> 
         <input type="text" name="titr" placeholder="titre ouvrage" value="<?php echo $titr?>" /><br /> 
         <input type="text" name="aut" placeholder="Auteur" value="<?php echo $aut?>" /><br /> 
         <input type="text" name="editi" placeholder="Edition" value="<?php echo $pass?>" /><br />  
         <input type="submit" name="valider" value="S'authentifier" />&nbsp &nbsp
